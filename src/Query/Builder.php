...
namespace Hyperf\Database\OdbcSqlServer\Query;

use Closure;
use Hyperf\Collection\Arr;
use Hyperf\Database\OdbcSqlServer\Exception\InvalidArgumentException;
use Hyperf\Database\Query\Builder as Base;
...
class Builder extends Base
{
     ...
     *
     * @param Builder|\Closure|Expression|string $column
